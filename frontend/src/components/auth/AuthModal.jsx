 ...
 * รองรับ Click Outside to Close และการสลับหน้า Login/Signup
 */
const AuthModal = ({ isOpen, onClose }) => {
    ...
    // ฟังก์ชันจัดการการคลิกพื้นหลัง (Click Outside)
    ...
    return (
        <div
            // แก้ไข: ใช้ grid place-items-center และ h-screen เพื่อบังคับให้อยู่กลางจอแน่นอน
        ...
        >
            <div
                // คงเดิม: แต่เช็คให้แน่ใจว่าไม่มี margin-top แปลกๆ
                ...
                <div className="p-10 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-gray-400 font-bold text-xs uppercase tracking-widest mt-2">
                            {isLogin ? 'Book2Sell Marketplace' : 'Start Selling Your Books'}
                        </p>
                    </div>
                    ...
                    <div className="mt-8 flex flex-col items-center gap-4">
                        ...
                        <div className="flex gap-4 w-full">
                            <button className="flex-1 flex justify-center py-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-all font-bold text-sm text-gray-600 gap-2">
